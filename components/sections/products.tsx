...
const products = [
  ...
  },
  {
    id: 7,
    name: "RedByOne",
    tagline: "Emergency Blood Donor Network",
    description: "Connect blood donors with those in urgent need through real-time matching, emergency requests, and hospital-ready coordination.",
    link: "/products/redbyone",
    status: "Live",
    image: "/images/bg-2.png",
    tags: ["Healthcare", "Emergency", "Matching"],
  },
  {
    id: 8,
    name: "ConfiguraX",
    tagline: "Production-ready Configuration Platform",
    description: "API-first product configuration platform with visual builder, enterprise security, and global-scale infrastructure.",
    link: "/products/configurax",
    status: "Live",
    image: "/images/bg-3.png",
    tags: ["SaaS", "API", "Configuration"],
  },
  {
    id: 1,
    name: "EazStart",
