...
const navItems = [
  ...
  {href: "/#works", label: "Work", number: "02" },
  { href: "/#team", label: "Team", number: "03" },
  { href: "/#unique-offerings", label: "What Makes Us Different", number: "04" },
  { href: "/#approach", label: "Our Approach", number: "05" },
  { href: "/#insights", label: "Research", number: "06" },
]
